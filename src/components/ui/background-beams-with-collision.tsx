...
const beams = [
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[40rem] bg-gradient-to-b from-white to-amber-50 dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden",
    ...
    >
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-amber-50 w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
